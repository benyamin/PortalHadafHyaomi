...
class NavigationActoinSheet:UIAlertController
{
    class func createWith(address:String?, latitude:Double?, longitude:Double?) -> NavigationActoinSheet {
        ...
        let actionSheet = NavigationActoinSheet(title: nil, message: nil, preferredStyle: UIAlertControllerStyle.actionSheet)
    ...
    private func addActions(address:String?, latitude:Double?, longitude:Double?){
        ...
        if address != nil {
            self.addAction(UIAlertAction(title: "st_copy.location.address".localize(), style: UIAlertActionStyle.default, handler: { (action) -> Void in
        ...
        if let requiredLatitude = latitude
            ...
            self.addAction(UIAlertAction(title: "st_copy.location.coordinates".localize(), style: UIAlertActionStyle.default, handler: { (action) -> Void in
                UIPasteboard.general.string = "\(requiredLatitude) , \(requiredLongitude)"
            }))
            
            if (UIApplication.shared.canOpenURL(URL(string:"http://maps.apple.com")!)) {
                
                self.addAction(UIAlertAction(title: "st_open_in_apple_maps".localize(), style: UIAlertActionStyle.default, handler: { (action) -> Void in
            ...
            if (UIApplication.shared.canOpenURL(URL(string:"comgooglemaps://")!)){
                ...
                self.addAction(UIAlertAction(title: "st_open_in_google_maps".localize(), style: UIAlertActionStyle.default, handler: { (action) -> Void in
            ...
            if (UIApplication.shared.canOpenURL(URL(string:"waze://")!)){
                ...
                self.addAction(UIAlertAction(title: "st_open_in_waze".localize(), style: UIAlertActionStyle.default, handler: { (action) -> Void in
        ...
        self.addAction(UIAlertAction(title: "st_cancel".localize(), style: UIAlertActionStyle.default, handler: { (action) -> Void in
