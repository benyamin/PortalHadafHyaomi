...
open class GetENPageProcess: MSBaseProcess
{
    ...
    func getPageByIndex(_ pageIndex:Int)
    {
        ...
        {
            var baseUrl = "https://www.sefaria.org.il/api/texts/"
            baseUrl += englishName
            ...
            if var urlComponents = URLComponents(string: baseUrl) {
                urlComponents.query = "commentary=0&context=1&pad=0&wrapLinks=1&multiple=0"
                    ...
                    if let error = error
                    {
                        ...
                        do {
                            ...
                            if let dictionary = try JSONSerialization.jsonObject(with: (data), options: JSONSerialization.ReadingOptions.mutableContainers) as? [String:Any]
                            {
                                ...
                                if let allText = dictionary["text"]
                                {
                                    fullText += self.buildTextDispalyFromData(allText)
                                }
                            }
                            ...
                            DispatchQueue.main.async {
                               ...
                               fullText =  "<!DOCTYPE html> <html> <head> <style> p.padding {padding-left: 1cm; padding-right: 1cm; padding-bottom: 0.5cm;} p.padding2 { padding-left: 50%; } </style> </head> <body> <p class=\"padding\">\(fullText)</p> </body> </html>"
