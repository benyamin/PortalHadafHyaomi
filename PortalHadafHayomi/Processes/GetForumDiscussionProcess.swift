//
//  GetForumDiscussionProcess.swift
//  PortalHadafHayomi
//
//  Created by Binyamin Trachtman on 18/09/2018.
//  Copyright © 2018 Binyamin Trachtman. All rights reserved.
//

import Foundation

open class GetForumDiscussionProcess: MSBaseProcess
{
    ...
    open override func executeWithObj(_ obj:Any?)
    {
        ...
        params["forummessagechildren"] = "1"
        params["forumid"] = self.discussoin!.forumid
        ...
        NetworkingManager.sharedManager.runRequest(request, onStart: {
            ...
            if let postsInfo = responseDctinoary["JsonResponse"] as? [[String:Any]]
            {
                ...
                for postInfo in postsInfo
                {
                    ...
                    post.forumid = self.discussoin?.forumid
